...
class _OrderScreenState extends State<OrderScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    cartProvider.getCartItems.entries.map((e) => a.add(e.value)).toList();

    List list = [];
    cartProvider.cartItems.values.forEach((element) => list.add(
        OrderItems(element.quantity!.toInt().toString(), element.productId!)));
